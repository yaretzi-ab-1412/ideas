                ...
                <div class="col-lg-6 align-self-center">
                    <div class="product-about">
                        ...
                        <div class="product_meta">
                            ...
                            <span class="posted_in">Category: <a href="shop.html">Bag, Fashion Hand Bag, Uncategorized.</a></span>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title"> Search Result for “Women”</h1>
                <ul class="breadcumb-menu">
                    <li><a href="electronics-shop.html">Home</a></li>
                    <li> Search Result for “Women”</li>
                </ul>
            </div>
        </div>
    </div><!--==============================
            ...
            <div class="row gx-40 flex-row-reverse">
                ...
                <div class="col-lg-3">
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_categories style2 radius p-24 mb-24">
                            <h3 class="widget_title">Categories</h3>
                            <ul>
                                <li>
                                    <a href="blog.html"><span></span>Fashion (6)</a>
                                </li>
                                <li>
                                    <a href="blog.html"><span></span> Electronics (4)</a>
                                </li>
                                <li>
                                    <a href="blog.html"><span></span> Grocery (7)</a>
                                </li>
                                <li>
                                    <a href="blog.html"><span></span> Furniture (5)</a>
                                </li>
                                <li>
                                    <a href="blog.html"><span></span> Medical(3)</a>
                                </li>
                                <li>
                                    <a href="blog.html"><span></span> Accessories (8)</a>
                                </li>
                                <li>
                                    <a href="blog.html"><span></span> New Arrivals (10)</a>
                                </li>
                                <li>
                                    <a href="blog.html"><span></span> jewellery (2)</a>
                                </li>
                            </ul>
                        </div>
                        <div class="widget widget_price_filter radius p-24 mb-24">
                            <h4 class="widget_title">Filter By Price</h4>
                            <div class="price_slider_wrapper">
                                <div class="price_slider"></div>
                                <div class="price">
                                    <div class="price_label">
                                        Price: <span class="from">$40 </span> — <span class="to">$350</span>
                                    </div>
                        ...
                        <div class="widget radius p-24 mb-24">
                            ...
                            <div>
                                <div class="product-size">
                                    <div class="th-size"><span class="rectangle"></span><span>S(6)</span></div>
                                    <div class="th-size"><span class="rectangle"></span><span>M(9)</span></div>
                                    <div class="th-size"><span class="rectangle"></span><span>L(8)</span></div>
                                    <div class="th-size"><span class="rectangle"></span><span>XL(7)</span></div>
                                    <div class="th-size"><span class="rectangle"></span><span>XS(5)</span></div>
                                    <div class="th-size"><span class="rectangle"></span><span>XXL(10)</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="widget widget_beige radius p-24 mb-24">
                            <h3 class="widget_title">Color:</h3>
                            <div class="beige-color style2">
                                <a href="shop-details.html"><span></span></a>
                                <a href="shop-details.html"><span></span></a>
                                <a href="shop-details.html"><span></span></a>
                                <a href="shop-details.html"><span></span></a>
                        ...
                        <div class="widget widget_offer space" data-bg-src="assets/img/bg/widget_bg_1.jpg">
